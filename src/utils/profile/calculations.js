 ...
 * Contains all calculation functions for profile statistics and rankings
 */

const { GHOST_HUNTER_RANKS, ACHIEVEMENTS } = require("./constants");

/**
 * Creates a progress bar with different styles
 */
...
/**
 * Creates an advanced progress bar with color coding
 */
...
/**
 * Calculates the current rank based on total hunts
 */
...
/**
 * Gets the next rank after the current one
 */
...
/**
 * Checks which achievements are unlocked and locked
 */
...
/**
 * Gets sanity status with emoji and description
 */
...
/**
 * Calculates advanced statistics for the profile
 */
...
/**
 * Calculates performance rating based on various factors
 */
...
/**
 * Sanitizes field values to prevent embed errors
 */
