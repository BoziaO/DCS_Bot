 ...
 * Prevents command spam and manages rate limiting
 */
...
class CooldownManager {
  ...
  /**
   * Create cooldown embed for user feedback
   */
  ...
  /**
   * Check and handle cooldown for interaction
   */
  ...
  /**
   * Clear cooldowns for a specific command (admin function)
   */
