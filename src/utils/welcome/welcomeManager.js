...
class WelcomeManager {
  ...
  /**
   * Przetwarza nowego członka serwera
   */
  ...
  /**
   * Przetwarza członka opuszczającego serwer
   */
  ...
  /**
   * Przetwarza konfigurację powitania
   */
  ...
  /**
   * Przetwarza konfigurację pożegnania
   */
  ...
  /**
   * Przygotowuje wiadomość powitalną
   */
  ...
  /**
   * Sprawdza czy członek przechodzi filtry
   */
  ...
  /**
   * Usuwa nieprawidłową konfigurację
   */
  ...
  /**
   * Czyści cache i resetuje statystyki
   */
  reset() {
