...
class WelcomeCache {
  ...
  /**
   * Pobiera konfiguracje powitań dla serwera
   */
  ...
  /**
   * Pobiera konfiguracje pożegnań dla serwera
   */
  ...
  /**
   * Pobiera konkretną konfigurację
   */
  ...
  /**
   * Invaliduje cache dla konkretnego kanału
   */
  ...
  /**
   * Optymalizuje cache - usuwa stare wpisy
   */
  optimize() {
  ...
  /**
   * Preładowuje cache dla aktywnych serwerów
   */
